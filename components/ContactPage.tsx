	...
	return (
		<section className='bg-white dark:bg-gray-800'>
			<div className='max-w-6xl mx-auto h-48 bg-white dark:bg-gray-800'>
				<h1 className='text-6xl md:text-9xl font-bold py-20 text-center md:text-left'>
					Contact
				</h1>
			</div>
			<div
				...
				<div className='max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 py-20 pb-40'>
					<div className='md:ml-4 mx-auto'>
						...
						<div className='icons-container inline-flex flex-col my-20'>
							<div className='flex flex-row items-center space-x-6 rounded-md border border-[#02044A] hover:border hover:border-blue-500 p-4 dark:bg-gray-800'>
								<svg
					...
					<form className='form rounded-lg bg-gray-200 dark:bg-gray-800 p-4 flex flex-col'>
						<label
							htmlFor='name'
